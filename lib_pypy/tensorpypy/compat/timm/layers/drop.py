# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from timm.layers.drop
# (timm 1.0.22, source sha256 3dc892acc4333156).  Do not edit; change the spec.
# Kept: drop_block_2d, DropBlock2d, drop_path, DropPath, calculate_drop_path_rates
...
def drop_block_2d(x, drop_prob=0.1, block_size=7, gamma_scale=1.0, with_noise=False, inplace=False, batchwise=False):
...
def drop_block_fast_2d(x, drop_prob=0.1, block_size=7, gamma_scale=1.0, with_noise=False, inplace=False):
    """ DropBlock. See https://arxiv.org/pdf/1810.12890.pdf
...
class DropPath(nn.Module):
    ...
    def extra_repr(self):
        return 'drop_prob={0:0.3f}'.format(round(self.drop_prob, 3))
