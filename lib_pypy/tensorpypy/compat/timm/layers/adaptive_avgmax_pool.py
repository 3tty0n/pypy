# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from timm.layers.adaptive_avgmax_pool
# (timm 1.0.22, source sha256 c82fd5bc5e44c0b2).  Do not edit; change the spec.
# Kept: adaptive_avgmax_pool2d, select_adaptive_pool2d, AdaptiveAvgMaxPool2d, SelectAdaptivePool2d
#   _int_tuple_2_t left unbound: a type alias only annotations read
from __future__ import absolute_import, division, print_function
import torch
import torch.nn as nn
import torch.nn.functional as F
from timm.layers.format import get_spatial_dim, get_channel_dim
...
class FastAdaptiveAvgPool(nn.Module):
    ...
    def __init__(self, flatten=False, input_fmt='NCHW'):
...
class SelectAdaptivePool2d(nn.Module):
    ...
    def __init__(self, output_size=1, pool_type='fast', flatten=False, input_fmt='NCHW'):
