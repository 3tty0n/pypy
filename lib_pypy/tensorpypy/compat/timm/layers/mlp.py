# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from timm.layers.mlp
# (timm 1.0.22, source sha256 c024128a1c7e2a55).  Do not edit; change the spec.
# Kept: Mlp, GluMlp, SwiGLUPacked, SwiGLU, GatedMlp, ConvMlp, GlobalResponseNormMlp
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, norm_layer=None, bias=True, drop=0.0, use_conv=False, device=None, dtype=None):
...
class GluMlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.Sigmoid, norm_layer=None, bias=True, drop=0.0, use_conv=False, gate_last=True, device=None, dtype=None):
        dd = {'device': device, 'dtype': dtype}
...
class SwiGLU(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.SiLU, norm_layer=None, bias=True, drop=0.0, align_to=0, device=None, dtype=None):
        dd = {'device': device, 'dtype': dtype}
...
class GatedMlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, norm_layer=None, gate_layer=None, bias=True, drop=0.0, device=None, dtype=None):
        dd = {'device': device, 'dtype': dtype}
...
class ConvMlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.ReLU, norm_layer=None, bias=True, drop=0.0, device=None, dtype=None):
        dd = {'device': device, 'dtype': dtype}
...
class GlobalResponseNormMlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, bias=True, drop=0.0, use_conv=False, device=None, dtype=None):
        dd = {'device': device, 'dtype': dtype}
        super(GlobalResponseNormMlp, self).__init__()
        out_features = out_features or in_features
        hidden_features = hidden_features or in_features
        bias = to_2tuple(bias)
        drop_probs = to_2tuple(drop)
