# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from timm.layers.split_attn
# (timm 1.0.22, source sha256 fb71f37b4b616848).  Do not edit; change the spec.
# Kept: SplitAttn
...
class SplitAttn(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=None, kernel_size=3, stride=1, padding=None, dilation=1, groups=1, bias=False, radix=2, rd_ratio=0.25, rd_channels=None, rd_divisor=8, act_layer=nn.ReLU, norm_layer=None, drop_layer=None, **kwargs):
        ...
        self.conv = nn.Conv2d(in_channels, mid_chs, kernel_size, stride, padding, dilation, groups=groups * radix, bias=bias, **dict(list(kwargs.items()) + list(dd.items())))
