...
pypy-jit-ext-c-no-heapcache:
	cd pypy/goal && PYPY_EXE_NAME=pypy-jit-ext-no-heapcache $(RUNINTERP) ../../rpython/bin/rpython $(JOBS) -Ojit --gen-extension --no-heapcache-genext-fastpath targetpypystandalone.py
