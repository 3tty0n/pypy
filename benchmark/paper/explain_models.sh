...
explain_row gpt2-medium gpt2_torch.py "$WEIGHTS/gpt2-medium"
...
explain_row smollm2-1.7b llama_torch.py "$WEIGHTS/smollm2-1.7b"
...
explain_row deit-tiny vit_torch.py "$WEIGHTS/deit-tiny"
