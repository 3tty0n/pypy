# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from transformers.models.trocr.modeling_trocr
# (transformers 5.13.0, source sha256 08bca3ac39d37199).  Do not edit; change the spec.
# Kept: logger, TrOCRForCausalLM
...
class TrOCRLearnedPositionalEmbedding(nn.Embedding):
    ...
    def __init__(self, num_embeddings, embedding_dim):
        self.offset = 2
        super(TrOCRLearnedPositionalEmbedding, self).__init__(num_embeddings + self.offset, embedding_dim)
    ...
    def forward(self, input_ids, past_key_values_length=0, position_ids=None):
        ...
        return super(TrOCRLearnedPositionalEmbedding, self).forward(position_ids + self.offset)
...
class TrOCRScaledWordEmbedding(nn.Embedding):
    ...
    def __init__(self, num_embeddings, embedding_dim, padding_idx, embed_scale=1.0):
        super(TrOCRScaledWordEmbedding, self).__init__(num_embeddings, embedding_dim, padding_idx)
        self.embed_scale = embed_scale

    def forward(self, input_ids):
        return super(TrOCRScaledWordEmbedding, self).forward(input_ids) * self.embed_scale

class TrOCRSinusoidalPositionalEmbedding(nn.Module):
    """This module produces sinusoidal positional embeddings of any length."""

    def __init__(self, num_positions, embedding_dim, padding_idx=None):
        super(TrOCRSinusoidalPositionalEmbedding, self).__init__()
        self.offset = 2
...
class TrOCRAttention(nn.Module):
    ...
    def __init__(self, config, embed_dim, num_heads, kdim=None, vdim=None, dropout=0.0, is_decoder=False, bias=True, is_cross_attention=False, layer_idx=None):
        super(TrOCRAttention, self).__init__()
...
class TrOCRDecoderLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config, layer_idx=None):
        super(TrOCRDecoderLayer, self).__init__()
    ...
    def forward(self, hidden_states, attention_mask=None, encoder_hidden_states=None, encoder_attention_mask=None, past_key_values=None, output_attentions=False, use_cache=True, **kwargs):
        """
        Args:
        ...
        hidden_states, self_attn_weights = self.self_attn(hidden_states=hidden_states, past_key_values=past_key_values, attention_mask=attention_mask, output_attentions=output_attentions)
...
class TrOCRDecoder(TrOCRPreTrainedModel):
    ...
    def __init__(self, config):
        super(TrOCRDecoder, self).__init__(config)
        self.dropout = config.dropout
    ...
    def forward(self, input_ids=None, attention_mask=None, encoder_hidden_states=None, encoder_attention_mask=None, past_key_values=None, inputs_embeds=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        """
        Args:
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.training:
                ...
                if dropout_probability < self.layerdrop:
                    continue
            layer_outputs = decoder_layer(hidden_states, attention_mask, encoder_hidden_states, encoder_attention_mask=encoder_attention_mask, past_key_values=past_key_values, output_attentions=output_attentions, use_cache=use_cache)
...
class TrOCRDecoderWrapper(TrOCRPreTrainedModel):
    ...
    def __init__(self, config):
        super(TrOCRDecoderWrapper, self).__init__(config)
...
class TrOCRForCausalLM(TrOCRPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        super(TrOCRForCausalLM, self).__init__(config)
    ...
    @auto_docstring
    def forward(self, input_ids=None, attention_mask=None, encoder_hidden_states=None, encoder_attention_mask=None, past_key_values=None, inputs_embeds=None, labels=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        """
