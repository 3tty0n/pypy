# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from torchvision.models.mobilenetv3
# (torchvision 0.29.0+cu130, source sha256 5444909362734ab5).  Do not edit; change the spec.
# Kept: InvertedResidualConfig, InvertedResidual, MobileNetV3, _mobilenet_v3_conf
...
class MobileNetV3(nn.Module):
    ...
    def __init__(self, inverted_residual_setting, last_channel, num_classes=1000, block=None, norm_layer=None, dropout=0.2, **kwargs):
        """
...
def _mobilenet_v3_conf(arch, width_mult=1.0, reduced_tail=False, dilated=False, **kwargs):
    ...
    if arch == 'mobilenet_v3_large':
        ...
        raise ValueError('Unsupported model type {0}'.format(arch))
