# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from transformers.models.qwen3.modeling_qwen3
# (transformers 5.13.0, source sha256 fbdcfeeb1b54135c).  Do not edit; change the spec.
# Kept: Qwen3ForCausalLM
...
class Qwen3RMSNorm(nn.Module):
    ...
    def __init__(self, hidden_size, eps=1e-06):
        ...
        """
        super(Qwen3RMSNorm, self).__init__()
    ...
    def extra_repr(self):
        return '{0}, eps={1}'.format(tuple(self.weight.shape), self.variance_epsilon)
...
class Qwen3RotaryEmbedding(nn.Module):
    ...
    def __init__(self, config, device=None):
        super(Qwen3RotaryEmbedding, self).__init__()
    ...
    def forward(self, x, position_ids):
        ...
        with maybe_autocast(device_type=device_type, enabled=False):
            freqs = inv_freq_expanded.float().__matmul__(position_ids_expanded.float()).transpose(1, 2)
...
class Qwen3PreTrainedModel(PreTrainedModel):
    ...
    _can_record_outputs = {'hidden_states': Qwen3DecoderLayer, 'attentions': Qwen3Attention}
...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    @capture_outputs
    @auto_docstring
    def forward(self, input_ids=None, attention_mask=None, position_ids=None, past_key_values=None, inputs_embeds=None, use_cache=None, **kwargs):
        ...
        if not isinstance(causal_mask_mapping, dict):
            mask_kwargs = {'config': self.config, 'inputs_embeds': inputs_embeds, 'attention_mask': attention_mask, 'past_key_values': past_key_values, 'position_ids': position_ids}
        ...
        for i, decoder_layer in enumerate(self.layers[:self.config.num_hidden_layers]):
            hidden_states = decoder_layer(hidden_states, attention_mask=causal_mask_mapping[self.config.layer_types[i]], position_embeddings=position_embeddings, position_ids=position_ids, past_key_values=past_key_values, use_cache=use_cache, **kwargs)
...
class Qwen3ForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    ...
    @can_return_tuple
    @auto_docstring
    def forward(self, input_ids=None, attention_mask=None, position_ids=None, past_key_values=None, inputs_embeds=None, labels=None, use_cache=None, logits_to_keep=0, **kwargs):
        """
        ...
        ```"""
        outputs = self.model(input_ids=input_ids, attention_mask=attention_mask, position_ids=position_ids, past_key_values=past_key_values, inputs_embeds=inputs_embeds, use_cache=use_cache, **kwargs)
