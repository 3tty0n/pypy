# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from torchvision.models.shufflenetv2
# (torchvision 0.29.0+cu130, source sha256 2c87bf229ea30b36).  Do not edit; change the spec.
# Kept: channel_shuffle, InvertedResidual, ShuffleNetV2
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, inp, oup, stride):
        ...
        if self.stride == 1 and inp != branch_features << 1:
            raise ValueError('Invalid combination of stride {0}, inp {1} and oup {2} values. If stride == 1 then inp should be equal to oup // 2 << 1.'.format(stride, inp, oup))
        if self.stride > 1:
...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, stages_repeats, stages_out_channels, num_classes=1000, inverted_residual=InvertedResidual):
        ...
        stage_names = ['stage{0}'.format(i) for i in [2, 3, 4]]
