# -*- coding: utf-8 -*-
# Generated by benchmark/suites/port.py from torchvision.models.squeezenet
# (torchvision 0.29.0+cu130, source sha256 6a98c53c42399ebf).  Do not edit; change the spec.
# Kept: Fire, SqueezeNet
...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, version='1_0', num_classes=1000, dropout=0.5):
        ...
        if version == '1_0':
            ...
            raise ValueError('Unsupported SqueezeNet version {0}: 1_0 or 1_1 expected'.format(version))
