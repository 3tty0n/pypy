...
PARAMETER_DOCS = {
    ...
    'hot_bridge_threshold': 'minimum cell_token.bridge_count before HBP promotes the failing guard to a loop variant (default 1; raise to skip benchmarks that spawn many one-shot bridges)',
