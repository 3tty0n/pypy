...
PARAMETER_DOCS = {
    ...
    'hot_bridge_ref_value_threshold': 'minimum exact-value failure count before HBP promotes reference guard_value failures (0=use hot_bridge_value_threshold/hot_bridge_guard_threshold; default 0)',
    ...
    'hot_bridge_bool_value_threshold': 'minimum failure count before HBP promotes bool-derived guard_value failures (0=use hot_bridge_guard_threshold; default 0)',
    ...
    'hbp_inherit_max_liveboxes': 'maximum guard liveboxes for HBP parent-state inheritance snapshots (0=unlimited; default 0)',
    ...
    'retrace_min_float_loop_bridges': 'minimum ordinary bridge count before ordinary retracing is allowed for traces containing float operations when retrace_limit > 0 (0=let float traces bypass retrace_min_loop_bridges; HBP-promoted variants are not blocked)',
    'retrace_min_loop_bridges_for_allocations': 'minimum ordinary bridge count before ordinary retracing is allowed if the candidate retrace contains allocations (0=stock retrace_limit behavior; HBP-promoted variants are not blocked)',
