...
let rec main n =
  let s = n * n in
  let ci = mrow (fillI (array s 0) 0 s) (fillI (array s 0) 0 s) (array s 0) 0 n 0 in
  let si = asum ci 0 s 0 in
  let cf = mrow (fillF (array s 0) 0 s) (fillF (array s 0) 0 s) (array s 0) 0 n (tofloat 0) in
  si + toint (asum cf 0 s (tofloat 0))
;;
