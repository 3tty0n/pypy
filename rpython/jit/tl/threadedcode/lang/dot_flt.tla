...
let rec drive v k iters m acc = if k >= iters then acc else drive v (k + 1) iters m (acc + toint (dot v v 0 m (tofloat 0))) ;;
let rec main m = drive (fillF (array m 0) 0 m) 0 600 m 0 ;;
