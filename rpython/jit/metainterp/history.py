...
class History(object):
    ...
    def record3_int(self, opnum, a1, a2, a3, intvalue, descr=None):
        pos = self.trace.record_op3(opnum, a1, a2, a3, descr)
        return IntFrontendOp(pos, intvalue)
    ...
    def record2_float(self, opnum, argbox1, argbox2, floatvalue,
                      descr=None):
        pos = self.trace.record_op2(opnum, argbox1, argbox2, descr)
        return FloatFrontendOp(pos, floatvalue)
