...
def compile_simple_and_split(metainterp, greenkey, trace, runtime_args, enable_opts,
                             cut_at):
    """
    Try to compile a trace which is generated by a baseline (or, method) JIT tracer
    """
    jitdriver_sd = metainterp.jitdriver_sd
    metainterp_sd = metainterp.staticdata
    jitcell_token = make_jitcell_token(jitdriver_sd)
