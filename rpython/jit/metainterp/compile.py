...
def compile_trace_and_split(metainterp, resumekey, runtime_boxes,
    ...
    body_token = newops[-1].getdescr()
    bridge_token = make_jitcell_token(jitdriver_sd)
    try:
