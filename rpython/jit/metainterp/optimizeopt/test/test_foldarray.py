...
from rpython.jit.metainterp.optimizeopt.foldarray import OptFoldArray
...
class TestOptFoldArray(BaseTestOptFoldArray):
    ...
    def test_remove_setarray_1(self):
        ...
        [p0, p1]
        p2 = getarrayitem_gc_r(p0, 0, descr=arraydescr)
        # p3 = getarrayitem_gc_r(p1, 0, descr=arraydescr) # should be removed
        # setarrayitem_gc(p1, 1, p2) # should be removed
        # p4 = getarrayitem_gc_r(p0, 0, descr=arraydescr) # should be removed
